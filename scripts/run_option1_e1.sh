#!/usr/bin/env bash
# run_option1_e1.sh — E1_2L baseline for v4 Option 1 state extension
...
julia "$REPO_ROOT/src/vfi_solver_v4.jl" \
    2>&1 | tee "$REPO_ROOT/output/diagnostics/p6_option1_e1_stdout.log"

echo "[run_option1_e1] Done at $(date)"
echo "[run_option1_e1] Summary JSON: $REPO_ROOT/output/diagnostics/p6_option1_e1.json"
