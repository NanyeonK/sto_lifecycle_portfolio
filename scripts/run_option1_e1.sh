#!/usr/bin/env bash
# Run E1_2L baseline under v4 (6D state, proper tau_buy).
...
#   N_X_PREV=5 bash scripts/run_option1_e1.sh   # finer x_prev grid
...
julia src/vfi_solver_v4.jl 2>&1 | tee "$OUT_DIR/p6_option1_e1_stdout.log"

echo "Done. Summary: $OUT_DIR/p6_option1_e1.json"
