#!/usr/bin/env bash
# Run E1_2L baseline using v4 solver (Option 1 full state extension).
...
SUMMARY_JSON="$OUT/p6_option1_e1.json"
LOG="$OUT/p6_option1_e1_stdout.log"

echo "[run_option1_e1] Starting E1_2L v4 baseline at $(date)"
...
echo "[run_option1_e1] Done at $(date). Summary: $SUMMARY_JSON"
