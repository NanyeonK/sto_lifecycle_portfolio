#!/usr/bin/env bash
# Run E2_2L_v4 Option 1 baseline on server1.
...
#
# After both e1 and e2 runs complete, compute CEV decomposition:
#   julia scripts/compute_cev_v4.jl  (to be added)
...
echo "=== v4 E2_2L Option 1 baseline ===" | tee "$STDOUT_LOG"
