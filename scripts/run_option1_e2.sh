#!/usr/bin/env bash
# E2_2L baseline run for v4 (Option 1 full state extension).
# N_W=15, N_Z=5, N_X_PREV=3 — ~2-3h wall single thread.
set -euo pipefail
...
echo "Done. Summary: output/diagnostics/p6_option1_e2.json"
