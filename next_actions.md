...
|---|---|---|---|
| 1 | DONE | cloud agent | branch `auto/2026-05-02-option1-state-extension` |
| 2 | DONE | cloud agent | `src/vfi_solver_v4.jl` (~700 LOC, 6D state) |
| 3 | DONE | cloud agent | env-var configurable: N_X_PREV=3, N_W=15, N_Z=5 |
| 4 | DONE | cloud agent | `smoke_test_v4()` callable via `--smoke-test` |
| 4b | DONE | cloud agent | `scripts/run_option1_smoke.sh`, `run_option1_e1.sh`, `run_option1_e2.sh` |
| 5 | Run smoke test on server1: `bash scripts/run_option1_smoke.sh` | user/me | `output/diagnostics/p6_option1_smoke.md` |
| 6 | Run E1_2L_v4 + E2_2L_v4 baselines: `bash scripts/run_option1_e{1,2}.sh` | user/me | `p6_option1_e*.json` |
