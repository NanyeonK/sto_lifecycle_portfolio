...
|---|---|---|---|
| 1 | Open new branch | cloud agent | `auto/2026-06-03-v4-state-extension` on origin |
| 2 | Create `src/vfi_solver_v4.jl`: 6D state + tx_cost on deltas + smoke test | cloud agent | **DONE 2026-06-03** — 692 LOC |
| 3 | N_X_PREV=3 coarse grid; N_W=15, N_Z=5; all env-var configurable | cloud agent | **DONE** (embedded in step 2) |
| 4 | Smoke test stub `smoke_test_v4()` — 6D alloc, tx_cost, housing cost, shock block | cloud agent | **DONE** — callable via `--smoke-test` |
