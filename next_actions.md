...
|---|---|---|---|
| 1 | DONE | cloud agent | branch `auto/2026-06-21-option1-state-extension` |
| 2 | DONE | cloud agent | `src/vfi_solver_v4.jl` (~620 LOC, 6D state + tx_cost on deltas) |
| 3 | DONE | cloud agent | env vars N_X_PREV=3 X_PREV_MAX=1.0 N_W=15 N_Z=5, all configurable |
| 4 | DONE | cloud agent | `smoke_test_v4()` callable via `julia src/vfi_solver_v4.jl --smoke-test` |
| 5 | Smoke test on server1 → record PASS/FAIL | user/me | `output/diagnostics/p6_option1_smoke.md` |
| 6 | Run E1_2L_v4 + E2_2L_v4 baselines (`bash scripts/run_option1_e1.sh` + `run_option1_e2.sh`) | user/me | `p6_option1_e*.json` |
| 7 | Compute CEV(E2_v4 vs E1_v4), check H1/H2/H3, write decomposition | user/me | `p6_option1_decomposition.md` |
