...
|---|---|---|---|
| 1 | Open new branch `auto/2026-05-02-option1-state-extension` | cloud agent | branch on origin | **DONE 2026-05-27** |
| 2 | Create `src/vfi_solver_v4.jl`: 6D state `(t, w, z, ell, x_A_prev, x_B_prev)` + tx_cost on deltas | cloud agent | file pushed | **DONE 2026-05-27** |
| 3 | Coarse `x_prev` grid N_X_PREV=3 {0,0.5,1.0}; N_W=15, N_Z=5 to compensate; all env-var configurable | cloud agent | in solver | **DONE 2026-05-27** |
| 4 | Smoke test stub `smoke_test_v4()` — 6D allocation, tx_cost, x_prev grid, terminal slice | cloud agent | `--smoke-test` flag | **DONE 2026-05-27** |
| 5 | Run smoke test on server1: `julia src/vfi_solver_v4.jl --smoke-test` | user/me | `output/diagnostics/p6_option1_smoke.md` | PENDING |
| 6 | Run E1_2L_v4: `bash scripts/run_option1_e1.sh` | user/me | `p6_option1_e1.json` | PENDING |
| 7 | Run E2_2L_v4: `bash scripts/run_option1_e2.sh` | user/me | `p6_option1_e2.json` | PENDING |
| 8 | Compute decomposition + check mean_xB > 0 (H1) | user/me | `p6_option1_decomposition.md` | PENDING |
