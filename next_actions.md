...
|---|---|---|---|
| 1 | Open new branch `auto/2026-05-27-option1-state-extension` | cloud agent | branch on origin |
| 2 | **DONE 2026-05-27** Create `src/vfi_solver_v4.jl`: 6D state `(t, w, z, ell, x_A_prev, x_B_prev)` + tx_cost on deltas | cloud agent | `src/vfi_solver_v4.jl` |
| 3 | **DONE 2026-05-27** Coarse `x_prev` grid N_X_PREV=3 {0, 0.5, 1.0}; N_W=15, N_Z=5; env-var configurable | cloud agent | `scripts/run_option1_e1.sh`, `run_option1_e2.sh` |
| 4 | **DONE 2026-05-27** Smoke test stub `smoke_test_v4()` — 6D alloc, tx_cost, admissibility, housing cost checks | cloud agent | callable via `--smoke-test` |
| 5 | Smoke test on server1 | user/me | `output/diagnostics/p6_option1_smoke.md` |
| 6 | Run E1_2L_v4 + E2_2L_v4 baselines | user/me | `p6_option1_e*.json` |
